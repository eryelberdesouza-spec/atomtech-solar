...
export const premissasConfig = mysqlTable('premissas_config', {
  ...
  baseIrradiacao: varchar('base_irradiacao', { length: 100 }).default('Atlas Brasileiro 2ª Ed. INPE 2017').notNull(),
  ...
  faseTensaoRede: varchar('fase_tensao_rede', { length: 30 }).default('Trifásico 127/220V').notNull(),
  ...
  // Campos adicionados via migration — migration_custos_padrao.sql
...
// ─── ITENS DE SERVIÇO (proposta genérica) ────────────────────────────────────
